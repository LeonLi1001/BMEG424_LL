...
Advantage: 
1. Visualization: Dimensionality reduction allows for visualization and intepretation of a dataset in a lower dimension space. 
2. Intepretability: with the help of visualizations, we can more easily identify meaningful relations and clusters. 

Disadvantage: 
1. Choice of Dimensionality reduction techniques: The performance of the techniques may vary based on the dataset
