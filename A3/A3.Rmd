...
```
**Add screenshot here:**
![heatmap_sample1](heatmap_sample1.png)
...
-----------------------------------------------------
Based on the previous analysis, sample 2 is H3K27me3. Based on the inference from Question 7 and 15, within sample 2's enhanced region, sample 3's expression is enhanced when sample 1 does not have any expression. This fits in the characteristic of a promoter therefore H3K27me3.
...
Yes sample 2 is H3K27me3. and sample 3 is H3K27ac. The first heatmap produced for question 5 provided strong evidence as cluster 1 and 2 have higher intensity peaks than sample 2, illustrating enhanced transcription activities. Question 15 also further confirmed the communicative relation between the two samples. For more detail please refer to the analysis conducted in question 5 and question 15. 
